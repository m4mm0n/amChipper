...
/// <summary>
/// Represents the AutomationEditorControl component.
/// </summary>
public partial class AutomationEditorControl : UserControl
{
    /// <summary>
    /// Stores or exposes _vm.
    /// </summary>
    private AutomationViewModel? _vm;
    ...
    private void OnDataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
    {
        ...
        _vm = DataContext as AutomationViewModel;
        Lane.ViewModel = _vm;
        if (_vm is not null)
            _vm.PropertyChanged += OnViewModelPropertyChanged;
